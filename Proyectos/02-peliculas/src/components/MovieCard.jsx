...
const MovieCard = ({ movie }) => {
  ...
  return (
    <>
      <div className="w-60 h-100 bg-gray-800 p-3 flex flex-col gap-4 rounded-br-3xl justify-between hover:shadow-2xl hover:gb-black transition-all duration-500 ease-in-out">
        <img
          src={imageUrl}
          alt={title}
